...
This is often because you are trying to access result_source_instance
before the call to table, e.g.

  __PACKAGE__->result_source_instance->view_definition('...');
  __PACKAGE__->table("page_attributes");

Ensure your call to table is before result_source_instance is accessed.
