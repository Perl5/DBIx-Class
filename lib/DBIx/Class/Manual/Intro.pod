...
B<Any time you would reach for a SQL query in DBI, you are creating a DBIx::Class::ResultSet.>
...
B<Setting up a ResultSet does not execute the query; retrieving the data does.>
